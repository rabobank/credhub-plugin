...
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o ${OUTPUT_DIR}/credhub-plugin-${VERSION}-linux-amd64 -ldflags "-X github.com/rabobank/credhub-splugin/conf.VERSION=${VERSION} -X github.com/rabobank/credhub-plugin/conf.COMMIT=${COMMIT}" .
